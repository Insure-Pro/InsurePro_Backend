...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    List<Customer> findAllByEmployeeAndCreatedAtBetweenAndCustomerTypeInAndDelYnFalse(Employee employee, Sort sort, LocalDateTime start, LocalDateTime finish, List<CustomerTType> customerTypes);
    List<Customer> findAllByEmployeeAndRegisterDateBetweenAndCustomerTypeInAndDelYnFalse(Employee employee, Sort sort, LocalDate start, LocalDate finish, List<CustomerTType> customerTypes);

    // 나이별
    List<Customer> findByEmployeeAndAgeBetweenAndDelYnFalseOrderByAge(Employee employee, int start, int end, Sort sort);
    List<Customer> findByEmployeeAndAgeBetweenAndCreatedAtBetweenAndCustomerTypeInAndDelYnFalseOrderByAge(Employee employee, int startAge, int endAge, Sort sort, LocalDateTime start, LocalDateTime finish, List<CustomerTType> customerTypes);
    List<Customer> findByEmployeeAndAgeBetweenAndRegisterDateBetweenAndCustomerTypeInAndDelYnFalseOrderByAge(Employee employee, int startAge, int endAge, Sort sort, LocalDate start, LocalDate finish, List<CustomerTType> customerTypes);

    // 지역별
    List<Customer> findByEmployeeAndDongStringContainsAndDelYnFalse(Employee employee, String dongName, Sort sort);
    List<Customer> findByEmployeeAndDongStringContainsAndCreatedAtBetweenAndDelYnFalse(Employee employee, String dongName, Sort sort, LocalDateTime start, LocalDateTime finish, List<CustomerTType> customerTypes);
    List<Customer> findByEmployeeAndDongStringContainsAndRegisterDateBetweenAndDelYnFalse(Employee employee, String dongName, Sort sort, LocalDate start, LocalDate finish, List<CustomerTType> customerTypes);
    ...
    List<Customer> findAllByEmployeeAndRegisterDateBetweenAndCustomerTypeInAndDelYnFalse(
            ...
            LocalDate start,
            LocalDate finish,
            List<CustomerTType> customerTypes
    );
