...
public class CustomerTypeService {
    ...
    public CustomerType patchCustomerType(CustomerType customerType) {
        ...
        Optional.ofNullable(customerType.getType()).ifPresent(customerType::setType);
        Optional.ofNullable(customerType.getDetail()).ifPresent(customerType::setDetail);
    ...
    public CustomerType verifiedCustomerType(long customerTypePk) {
        ...
        return customerType.orElseThrow(() -> new BusinessLogicException(ExceptionCode.CUSTOMER_TYPE_NOT_FOUND));
    }
}
