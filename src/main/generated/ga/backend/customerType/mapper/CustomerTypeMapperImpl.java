...
public class CustomerTypeMapperImpl implements CustomerTypeMapper {
    ...
    @Override
    public List<CustomerTypeResponseDto.Response> customerTypeToCustomerTypeListResponseDto(List<CustomerType> customerTypes) {
        if ( customerTypes == null ) {
            return null;
        }

        List<CustomerTypeResponseDto.Response> list = new ArrayList<CustomerTypeResponseDto.Response>( customerTypes.size() );
        for ( CustomerType customerType : customerTypes ) {
            list.add( customerTypeToCustomerTypeResponseDto( customerType ) );
        }
